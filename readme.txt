...
[Check Demo Website Using eZee Booking Engine](http://ezeereservation.com/demo/)
...
[Explore all features](http://ezeereservation.com/booking-engine.php)

eZee Reservation is the perfect solution for hotels, B&B, resorts, hotel chains, motels or any other accommodation type that want to receive direct bookings from their website. 

The eZee Booking WordPress plugin is free to use, but you do [need an account](http://ezeereservation.com/free-trial.php) on [www.eZeeReservation.com.](http://ezeereservation.com/)
...
1. Create your [eZee account](http://ezeereservation.com/free-trial.php) & check [documentation](http://ezeereservation.com/resdemodoc/wordpress.php) for further configuration
...
Yes, you can create a free trial account from the following link http://ezeereservation.com/free-trial.php
